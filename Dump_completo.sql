...
CREATE TABLE `estudiantes` (
  `legajo` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `tipo_identificacion` varchar(5) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `estudiante` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `facultad` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `programa` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `regionalizacion` varchar(1) COLLATE utf8mb4_general_ci NOT NULL,
  `sede` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `jornada` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Table structure for table `projects_compilado`
--

DROP TABLE IF EXISTS `projects_compilado`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `projects_compilado` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `fecha` date NOT NULL,
  `sesion` int NOT NULL,
  `programa` varchar(500) COLLATE utf8mb4_general_ci NOT NULL,
  `estudiante_id` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `modalidad` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `asunto` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `director_id` int DEFAULT NULL,
  `resolucion` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `programa_profesor` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `compilado_director_id_c5b7aad2` (`director_id`),
  KEY `compilado_estudiante_id_dd6be708` (`estudiante_id`),
  CONSTRAINT `compilado_director_id_c5b7aad2_fk_docentes_id` FOREIGN KEY (`director_id`) REFERENCES `docentes` (`id`),
  CONSTRAINT `compilado_estudiante_id_dd6be708_fk_estudiantes_legajo` FOREIGN KEY (`estudiante_id`) REFERENCES `estudiantes` (`legajo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-10-15 23:48:32
